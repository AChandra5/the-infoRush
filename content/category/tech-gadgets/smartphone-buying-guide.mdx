...
>
  <thead>
    <tr style={{ backgroundColor: "#f4f4f4" }}>
      <th style = {{ backgroundColor: "#0D3483", color: "white", padding: "12px", border: "1px solid #ccc", fontSize: "1rem" }}
      >
        Use Case
      </th>
      <th style = {{ backgroundColor: "#0D3483", color: "white", padding: "12px", border: "1px solid #ccc", fontSize: "1rem" }}
  ...
  <tbody>
    <tr>
      ...
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>
        <strong>AMOLED, Stereo Speakers, HDR, Brightness</strong>
      </td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}><strong>Gaming</strong></td>
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>
        Good GPU (Dimensity/Snapdragon), 120Hz, Cooling
      </td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>
      ...
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>
        OIS, Night Mode, Large Sensor, AI Imaging
      </td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>
