...
>
  <thead>
    <tr style={{ backgroundColor: "#f4f4f4", fontSize: "1rem" }}>
      <th style = {{ backgroundColor: "#0D3483", color: "white", padding: "12px", border: "1px solid #ccc" }}>Smartphone Segment</th>
      <th style = {{ backgroundColor: "#0D3483", color: "white", padding: "12px", border: "1px solid #ccc" }}>AnTuTu Score range</th>
      <th style = {{ backgroundColor: "#0D3483", color: "white", padding: "12px", border: "1px solid #ccc" }}>Geekbench Score range (Single / Multi-core)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>Budget</td>
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>Below 500,000</td>
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>500–1000 / 1200–1800</td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>Mid-range</td>
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>600,000 – 800,000</td>
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>1000–1300 / 2500–3000</td>
    </tr>
    <tr>
      ...
      <td style={{ border: "1px solid #dbdde0", padding: "10px", fontSize: "1rem" }}>1300+ / 4000+</td>
    </tr>
  </tbody>
</table>
