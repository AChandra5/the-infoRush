  ...
  >
    <thead>
      <tr style={{ backgroundColor: "#0D3483", color: "white" }}>
        ...
        <th style={{ padding: "12px", textAlign: "center" }}>Toss Bias Indicator</th>
      </tr>
    </thead>
    <tbody>
      <tr style={{ backgroundColor: "#" }}>
        <td style={{ padding: "10px", border: "1px solid #ddd" }}><b>Test Matches</b></td>
        <td style={{ padding: "10px", border: "1px solid #ddd" }}>~34%</td>
        <td style={{ padding: "10px", border: "1px solid #ddd" }}>Low to Moderate</td>
      </tr>
      <tr>
        <td style={{ padding: "10px", border: "1px solid #ddd" }}><b>ODIs</b></td>
        <td style={{ padding: "10px", border: "1px solid #ddd" }}>~49%</td>
        <td style={{ padding: "10px", border: "1px solid #ddd" }}>Moderate</td>
      </tr>
      <tr style={{ backgroundColor: "#" }}>
        <td style={{ padding: "10px", border: "1px solid #ddd" }}><b>T20 Internationals</b></td>
        <td style={{ padding: "10px", border: "1px solid #ddd" }}>~52%</td>
        <td style={{ padding: "10px", border: "1px solid #ddd" }}>High, especially in night matches</td>
      </tr>        
    </tbody>
  </table>
</div>
